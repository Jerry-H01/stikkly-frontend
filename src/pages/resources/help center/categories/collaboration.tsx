...
const CollaborationHelpPage: React.FC = () => {
      ...
      <section className="px-6 md:px-[128px] mb-16">
        <div className="max-w-[1728px] mx-auto">
          ...
          <p className="text-[15px] text-[#475467] leading-relaxed max-w-[760px]">
            Stikkly is built for teams. Invite members, assign tasks, share
            boards, and work together in real time — all in one place.
          </p>
        </div>
      </section>
...
export default CollaborationHelpPage;
